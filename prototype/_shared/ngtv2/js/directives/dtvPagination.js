(function() {
  ...
  function dtvPagination($compile, $dtvCarousel) {
      ...
      // Initalize the Carousel and listen for page index changes
  		function initCarousel() {
	    	$dtvCarousel.get($scope.id).then(function(carousel) {
	    		Carousel = carousel;
    ...
    function link(scope, element, attrs, ctrl) {
      ...
      // Get the pagination item
    	var item = angular.element(element[0].querySelector('.dtv-pagination-item'));
  ...
  function dtvPaginationItem() {

    function link(scope, element, attr, ctrl) {
    	element.addClass('dtv-pagination-item');
  ...
  angular
    .module('dtvCarousel')
    .directive('dtvPagination', dtvPagination)
    .directive('dtvPaginationItem', dtvPaginationItem);
