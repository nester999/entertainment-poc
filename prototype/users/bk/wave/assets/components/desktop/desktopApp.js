var desktop = angular.module('ngtvApp.desktop', ['dtv.api', 'dtv.assetCard', 'dtv.list', 'dtv.utils', 'dtv.background']);


desktop.service('$dtvIntent', ['$location', '$stateParams', '$state',
